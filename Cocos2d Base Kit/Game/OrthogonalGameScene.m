...
#import "OrthogonalGameScene.h"
#import "SimpleAudioEngine.h"


@implementation OrthogonalGameScene

- (void) didLoadFromCCB
{
    CCLOG(@"Game Level did load==========");
    tileMap = [CCTMXTiledMap tiledMapWithTMXFile:@"tilemap.tmx"];
    [self addChild:tileMap z:-1 tag:TileMapNode];

    CCTMXLayer *eventLayer = [tileMap layerNamed:@"EventLayer"];
...
-(void) ccTouchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    CCTMXLayer* eventLayer = [tileMap layerNamed:@"EventLayer"];
    CCTMXLayer *pathLayer = [tileMap layerNamed:@"PathLayer"];
    int tileGID = [eventLayer tileGIDAt:tilePos];
    int tileGID2 = [pathLayer tileGIDAt:tilePos];
    ...
    else
    {
        ...
        eventLayer = [tileMap layerNamed:@"EventLayer"];
        eventLayer.visible = !eventLayer.visible;
